...
public class IfEx17 {
	...
	public static void main(String[] args) {
		...
		if (finalScore >= 20) {// 조건식이 true 일때 실행
		...
		if (finalScore > 90) { //조건식의 true 일 때 사용
			System.out.println("A");
		}
		else if(finalScore > 80) {//위 조건식이 false이고(else) 해당 조건식이 true일 때 실행
			System.out.println("B");
		}
		else if (finalScore > 70) {//위 조건식이 false이고(else) 해당 조건식이 true일 때 실행
