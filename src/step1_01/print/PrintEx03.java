...
import java.util.Date;// 날짜+ 시간

import javax.sound.midi.Soundbank;

import java.text.DecimalFormat;
//import java.sql.Date;// 날짜만
...
public class PrintEx03 {
	...
	public static void main(String[] args) {
		...
		System.out.println("C:\\coupang\\file_img_repo");
		...
		Date time1 = new Date(); //객체 생성
		System.out.println(time1);//Tue Nov 21 11:30:40 KST 2023
		
		long time2 = System.currentTimeMillis();
		System.out.println(time2);//1700533592776
